...
void GL_SetDefaultState()
{
	...
	// foresthale 2014-02-23: switch to system framebuffer before we set default state as the glDrawBuffer(GL_BACK) and glReadBuffer(GL_BACK) would just cause errors
